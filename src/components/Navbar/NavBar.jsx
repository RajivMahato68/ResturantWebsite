    ...
    <div className="relative w-full bg-red-40">
      ...
      <div className="mx-auto flex max-w-7xl h-16 items-center justify-between px-4 py-2  sm:px-6 lg:px-8 ">
        <div className="inline-flex items-center space-x-2 px-8">
           ...
           <img src={Logo} alt="logo" className="h-[4rem] w-[4rem] object-fit" />
        ...
        <div className="lg:hidden">
          <Menu onClick={toggleMenu} className="h-6 w-6 cursor-pointer text-[#f38220]" />
        </div>
        {isMenuOpen && (
              ...
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                      ...
                      <img src={Logo} alt="logo" className="w-16 h-16 object-fit" />
                  ...
                  <div className="-mr-2">
                    ...
                    >
                      ...
                      <X className="h-6 w-6 text-[#f38220] " aria-hidden="true" />
                    </button>
                  </div>
                </div>
                <div className="mt-6">
