  ...
  return (
    ...
    >
      ...
      <div className="md:pl-[150px] pl-[30px] ">
        <button className=' bg-[#f38220] w-[118px] h-[44px] text-[16px] text-white font-["Plus_Jakarta_Sans"]text-center rounded mt-20 hover:bg-[#b9763a] md:justify-center mb-5'>
          Reservation
        </button>
