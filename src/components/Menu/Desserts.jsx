...
import DesertSvg from './SVG/DesertSvg'
  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-20">
        <div>
          <DesertSvg className="w-[200px] h-[200px] ml-5" />
        </div>
      </div>
      
      {/* Heading with underlined text */}
      <h1 className="font-bold text-[36px] flex justify-center underline decoration-[#f38220] decoration-2 underline-offset-8 mb-5">
      Desserts
      </h1>

      {/* Container for the card grid */}
      <div className="container mx-auto p-4 md:px-[100px] cursor-pointer">
        {/* Grid layout for cards */}
        <div className="grid grid-cols-1 gap-[10px] md:grid-cols-2 lg:grid-cols-2">
