        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="w-full md:w-1/4 xl:w-1/4 p-6 flex flex-col items-center">
            <img
              ...
              alt="MoMo Street"
            />
            <p className="text-gray-400 md:text-center text-justify ">
          ...
          <div className="w-full md:w-1/4 xl:w-1/4 p-6 ml-20">
            <h3 className="text-2xl font-normal text-white  mb-4 underline-bold underline decoration-[#f38221] decoration-4 underline-offset-4 font-sans-serif">
              Quick Links
            </h3>
          ...
          <div className="w-full md:w-1/4 xl:w-1/4 p-6">
            <h3
              className="text-lg font-bold mb-4 underline-bold"
              style={{
                color: "rgb(230, 130, 43)",
            ...
            <form className="flex mb-5">
              ...
              <button
                type="submit"
                className=" bg-[#ffff] text-[#f38220] hover:text-white border border-gray-700 rounded px-3 py-2 mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500 w-2/4 ml-2 hover:border-[#e9252f] hover:bg-[#E9252F]"
              >
                Submit
              </button>
            </form>
