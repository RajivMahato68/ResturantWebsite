...
function Footer() {
  ...
  <div className="flex md:pr-24  items-center space-x-2 text-lg mt-10 ">
          ...
          <h3 className="text-lg font-bold mb-4 underline-bold" style={{color: 'rgb(230, 130, 43)', textDecoration: 'underline', textUnderlineOffset: '3px'}}>Quick Links</h3>
          ...
          <h3 className="text-lg font-bold mb-4 underline-bold" style={{color: 'rgb(230, 130, 43)', textDecoration: 'underline', textUnderlineOffset: '3px'}}>Stay up to date</h3>
...
<div className="text-gray-400  space-x-1 flex items-center mb-3 ">
          ...
          <div className="w-full md:w-1/4 xl:w-1/4 p-6">
          <h3 className="text-lg font-bold mb-4 underline-bold" style={{color: 'rgb(230, 130, 43)', textDecoration: 'underline', textUnderlineOffset: '3px'}}>Galary</h3>
