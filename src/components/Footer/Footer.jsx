...
const Footer = () => {
  ...
  const stayUpToDate = [
    { label: <SlLocationPin className='w-[18px] h-[18px]' />, value: 'Kathmandu,Nepal' },
    { label: <MdOutlineEmail className='w-[18px] h-[18px]' />, value: 'Roel.Rodriguez@gmail.com' },
    { label: <FiPhone className='w-[18px] h-[18px]' />, value: '+977-9898989890' },
  ];
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row lg:justify-between">
          <div className="lg:w-1/4 mb-6 lg:mb-0  text-center">
            <img src={Logo} alt="logo" className="h-[70px] w-[70px] mx-auto  lg:ml-[6rem] object-fit" />
          ...
          <div className="lg:w-1/4 mb-6 lg:mb-0 lg:ml-[3rem] text-center">
            <h5 className="mb-4 border-b-2 border-[#F38220] inline-block font-plus-jakarta-sans font-semibold text-[22px] text-center lg:text-left ">Quick Links</h5>
          ...
          <div className="lg:w-1/4 mb-6 lg:mb-0 text-center">
            <h5 className="mb-4  border-b-2 border-[#F38220] inline-block font-plus-jakarta-sans font-semibold text-[22px] text-center ">Schedule</h5>
            <ul className="list-none text-[#d8d2d2]  lg:mr-[1rem]">
              {schedule.map((scheduleItem, index) => (
                <li key={index} className="mb-5 lg:text-center ">
                  ...
                  <span className="text-[16px] block">{scheduleItem.hours}</span>
                </li>
              ))}
            </ul>
          </div>
          <div className="lg:w-1/4">
            <h5 className="mb-4 border-b-2 border-[#F38220] inline-block font-plus-jakarta-sans font-semibold text-[22px] text-center ml-[4rem] lg:ml-[3rem] ">Stay up to date</h5>
            ...
            <ul className="text-[#c7bfb7] text-[12px] text-center">
              {stayUpToDate.map((item, index) => (
                <li key={index} className="flex mb-3  text-center ml-[4rem] lg:ml-[0rem] lg:justify-start">
